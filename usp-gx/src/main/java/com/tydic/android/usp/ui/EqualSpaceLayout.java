...
public class EqualSpaceLayout extends ViewGroup {
	...
	public EqualSpaceLayout(Context context, AttributeSet attrs) {
		...
		{
			TypedArray a = context.obtainStyledAttributes(attrs, new int[] { android.R.attr.layout_width, android.R.attr.layout_height, });
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		final int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(maxChildWidth), MeasureSpec.AT_MOST);
		final int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(maxChildHeight), MeasureSpec.AT_MOST);
